  ...
  final events = [
    {
      ...
      'type': 'In-Person',
      'location': 'Phnom Penh — Factory Phnom Penh',
    ...
    },
    {
      ...
      'type': 'Workshop',
      'location': 'Siem Reap — Heritage Hub',
...
class _EventCardState extends State<_EventCard> {
  ...
  Widget _dateCircle(Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (widget.isBooked ? Colors.green : color).withOpacity(0.3), 
            blurRadius: 10, 
  ...
  Widget _eventBadge(Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: (widget.isBooked ? Colors.green : color).withOpacity(0.1),
